        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
            {prices.map((item, idx) => (
              <div
                key={idx}
                className="relative rounded-xl border border-border bg-card overflow-hidden hover:shadow-md transition-shadow"
              >
                <div className="h-20 overflow-hidden">
                  <img
                    ...
                    loading="lazy"
                    onError={(e) => {
                      (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=200';
                    }}
                  />
                </div>
                <div className="p-2.5">
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    ...
                    <span className={`text-[10px] font-medium ${
                      ...
                      item.trend === 'down' ? 'text-emerald-500' : 'text-muted-foreground'
                    }`}>
